<template>
    <v-container grid-list-lg>
        <v-layout row>
            <v-flex xs12 class="text-xs-center display-1 font-
            weight-black my-5">Available Meal Plans</v-flex>
        </v-layout>
        <v-layout row wrap>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <div>The Keto diet is a high-fat, adequate-protein, low-carbohydrate diet.
                                The diet forces the body to burn fats rather than carbohydrates by putting 
                                the body into ketosis.
                            </div>
                        </div>
                    </v-card-text>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <div>The Paleo diet requires the sole of predominant consumption of
                                foods presumed to have been the only food available to or consumed
            ...
            <v-flex xs12 sm12 md4>
                ...
                <v-card-text>
                    <div>
                        ...
                        <div>The vegan diet abstains from the use of animal products. The vegan diet 
                            does not consume meat, diary products, eggs or any all other animal-derived
                            ingredients.
                        </div>
                    </div>
                </v-card-text>
